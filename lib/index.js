...
exports.RequestMapping = exports.all = exports.del = exports.put = exports.post = exports.get = exports.setRequiredParamsErrorHandler = exports.paramsRequired = exports.Controller = exports.injectAllRoutes = exports.RoutesKey = exports.Method = void 0;
const fs = require('fs');
const { resolve } = require('path');
const routesList = [];
let requiredParamsErrorHandler = null;
var Method;
(function (Method) {
    Method["ALL"] = "all";
...
function setRequiredParamsErrorHandler(callback) {
    if (typeof callback !== 'function') {
        return console.error('param must be a function.');
    }
    requiredParamsErrorHandler = callback;
}
exports.setRequiredParamsErrorHandler = setRequiredParamsErrorHandler;
function get(url) {
